...
var MST = moment().tz("America/Denver").format()
console.log(MST);


module.exports = function(eventLength, transitionLength) {
	var currentTime = moment().tz("America/Denver").format();
	...
	for (var i =0; i < intervals; i++) {
		...
		start_times.push( moment().tz("America/Denver").format() ).startOf('hour').add(i * eventLength - transitionLength, 'ms');
	}
